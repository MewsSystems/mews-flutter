...
@widgetbook.UseCase(name: 'Default', type: OptimusSearch, path: '[Forms]')
Widget createDefaultStyle(BuildContext _) => ConstrainedBox(
  constraints: const BoxConstraints(maxWidth: 400),
  child: const _SearchStory(),
);

@widgetbook.UseCase(name: 'Nested', type: OptimusSearch, path: '[Forms]')
Widget createNestedStyle(BuildContext _) =>
    NestedWrapper((context) => const _SearchStory());
