...
class OptimusTokensTheme extends ThemeExtension<OptimusTokensTheme>
    with _$OptimusTokensTailorMixin {
  const OptimusTokensTheme({
  ...
  static const lightOptimusTokensTheme = OptimusTokensTheme(
  ...
  static const darkOptimusTokensTheme = OptimusTokensTheme(
