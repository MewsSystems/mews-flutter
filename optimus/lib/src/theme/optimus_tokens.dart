...
class OptimusTokens extends ThemeExtension<OptimusTokens>
  ...
  factory OptimusTokens.light() => const OptimusTokens(
        backgroundAccent: DesignTokensLight.backgroundAccent,
  ...
  factory OptimusTokens.dark() => const OptimusTokens(
        backgroundAccent: DesignTokensDark.backgroundAccent,
        backgroundAlertBasicPrimary:
